...
// Query to select data from tamu table where Keterangan = 'Hadir'
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Laporan Kehadiran</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <!-- Add download button -->
                                <div style="align:right;" class="container6" >
                                    <div class="form-container6">
                                    <form action="excel.php" method="GET">
                                    <button type="button" class="btn btn-primary" onclick="location.href='excel.php';"><i class="fa fa-download"></i>  Download Laporan Kehadiran</button>
                                    </form>
                                    </div>
                                </div><br>
